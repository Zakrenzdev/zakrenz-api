...
export default function Home({ stats }) {
    ...
    return (
        <div className={styles.container}>
            <Head>
                <title>ZAKRENZ - API | Welcome</title>
            </Head>

            <div className={styles.content}>
                <h1 className={`${styles.title} shiny-text`}>ZAKRENZ - API</h1>
                ...
                >
                    <div className={styles.creatorCardContent}>
                        ...
                        <h2 className={styles.creatorName}>ZakrenzModder</h2>
                        <p className={styles.creatorRole}>Reverse Engineering</p>
                    </div>
                </div>
            </div>
        </div>
